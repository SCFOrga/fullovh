...
$req =$bdd->prepare('SELECT * FROM `EauSemaine`  ORDER BY `dateSemaine` DESC LIMIT 10 ');
$req ->execute();
$temp = array();
...
<html>
<head>
    <title>Graphique de consommation d'eau</title>
...
<body>
<div class="txt"><h3>Graphique de la consommation d'<u>Eau</u>par semaine</h3></div>
