...
$bdd = new PDO("mysql:host=by93828-001.privatesql;dbname=scf2023;port=35146" , "scf2023", "VDGE462zgrt23");
 $req =$bdd->prepare('SELECT * FROM `DonneesTemp`  ORDER BY `date_recept` DESC LIMIT 10 ');
$req ->execute();
$temp = array();
...
<body>
<div class="txt"><h3>Graphique de <u>température</u></h3></div>
...
{
    $data[substr($temp[$i]['date_recept'], 11, 8)] = intval($temp[$i]['donnees']);
}
//print_r($temp);
