...
$req =$bdd->prepare('SELECT * FROM `ChauffSemaine`  ORDER BY `dateSemaine` DESC LIMIT 10 ');
$req ->execute();
$temp = array();
...
<html>
<head>
    <title>Graphique de consommation de chauffage</title>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="graphM.php">Conso / Mois</a>
                    </li>
                    <li class="nav-item">
...
<body>
<div class="txt"><h3>Graphique de la consommation du <u>Chauffage</u> par semaine</h3></div>
...
{
    $data[substr($temp[$i]['dateSemaine'], 0, 10)] = intval($temp[$i]['conso']);
}
//print_r($temp);
