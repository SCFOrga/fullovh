...
$req =$bdd->prepare('SELECT * FROM `ElecSemaine`  ORDER BY `dateSemaine` DESC LIMIT 10 ');
$req ->execute();
$temp = array();
...
<body>
<div class="txt"><h3>Graphique de la consommation d'<u>Electricité</u> par semaine</h3></div>
